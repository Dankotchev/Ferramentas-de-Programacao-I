package br.edu.ifsp.pep.aulainalgural;

import br.edu.ifsp.pep.aulainalgural.modelo.Pessoa;
...
public class Principal {
    ...
    public static void main(String[] args) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("FP1C4Aula01PU");
